...
def load_models(
...
) -> Tuple[AutoModelForCausalLM, PeftModel]:
    # Import both models at the same time in memory
    ...
    return base_model, reinforced_model
...
def main():
    ...
    base_model, reinforced_model = load_models(
